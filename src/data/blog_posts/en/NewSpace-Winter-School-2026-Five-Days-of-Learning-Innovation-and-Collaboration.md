...
tags:
  ...
  - NewSpace
  - Hackathon
excerpt: 'The first edition of the NewSpace Winter School brought together 50 students for five days of lectures, workshops and a Hackathon dedicated to the sustainability of space operations.'
---
...
The **Telescopes** block focused on the study of the universe from Earth, exploring scientific instruments and technologies used in astrophysical research. The **Satellites** block focused on the study of Earth and space from orbit, with particular attention to current applications and emerging trends in NewSpace.

The **Downstream** theme highlighted the use of space-derived data for applications on Earth, such as Earth observation and the development of services based on satellite data. The **Launchers** block explored the technologies associated with access to space, analysing different solutions and international examples.
...
This edition’s challenge focused on the **sustainability of space operations**. As the number of satellites and launches increases, Earth orbit is becoming increasingly congested, leading to a rise in space debris and collision risks. In this context, ensuring that future space operations are **safe, efficient and sustainable** is one of the major challenges facing the space industry.
...
The diversity of academic backgrounds contributed to a multidisciplinary environment, with students from areas such as Engineering Physics, Physics, Mechanical Engineering and Aerospace Engineering, among others. This variety of profiles proved particularly valuable during the practical activities and especially during the Hackathon.

In addition to the participants, the **NewSpace Winter School** counted on the involvement of **speakers, mentors and partners** from several academic, scientific and business organisations, strengthening the connection between students and the **national space ecosystem**.

Over the five days, participants had contact with professionals and researchers from institutions such as the **Faculty of Sciences of the University of Lisbon, Instituto Superior Técnico, the Institute of Astrophysics and Space Sciences, LIP, N3O, Critical Software, GEOSAT, Thales Portugal, Omnidea, Beyond Gravity, PwC, Vieira de Almeida and TecLabs**.

This diversity of contributions made it possible to approach the space sector from several perspectives — scientific, technological, economic, legal and communicational — bringing participants closer to the multidisciplinary reality of NewSpace.
...
The enthusiasm and engagement shown by the participants highlight the potential of this initiative to continue growing and contributing to the training of a new generation interested in exploring the challenges and opportunities of the space sector.

This first edition therefore marks the beginning of a project dedicated to bringing students closer to the world of space, encouraging learning, collaboration and innovation within the context of the space sector.
