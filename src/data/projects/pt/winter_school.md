...
A Escola de Inverno NewSpace, organizada pela Espaço ao Cubo, é um curso de uma semana destinado a estudantes universitários com interesse em Física, Engenharia, Tecnologias Espaciais, Gestão e Direito Espacial.

## Sobre o Programa

Durante um período de cinco dias, os participantes irão participar em palestras temáticas e sessões de workshop focadas nos principais pilares do ecossistema NewSpace. Cada bloco combina fundamentos teóricos com aprendizagem prática, promovendo conhecimento técnico, pensamento interdisciplinar e competências de resolução criativa de problemas.
...
### 💡 HACKATHON
A Escola de Inverno culmina com uma Hackathon de 24 horas, onde equipas multidisciplinares aplicam o conhecimento adquirido ao longo da semana para desenvolver um projeto criativo relacionado com NewSpace.
...
<div style="display: flex; gap: 2rem; align-items: center; margin: 2rem 0; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 250px;">
    ...
    <p style="margin: 0.5rem 0; color: #b8dbc4;">Especialista em Gestão de Projetos Espaciais</p>
  </div>
</div>
...
<div style="display: flex; gap: 2rem; align-items: center; margin: 2rem 0; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 250px;">
    ...
    <p style="margin: 0.5rem 0; color: #b8dbc4;">Investigador - FCUL & Instituto de Astrofísica</p>
  </div>
</div>
...
<div style="display: flex; gap: 2rem; align-items: center; margin: 2rem 0; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 250px;">
    ...
    <p style="margin: 0.5rem 0; color: #b8dbc4;">N3O - Equipa de Nanosatélites</p>
  </div>
</div>
...
<div style="display: flex; gap: 2rem; align-items: center; margin: 2rem 0; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 250px;">
    ...
    <p style="margin: 0.5rem 0; color: #b8dbc4;">Aplicações de Dados Satelitares</p>
  </div>
</div>
...
<div style="display: flex; gap: 2rem; align-items: center; margin: 2rem 0; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 250px;">
    ...
    <p style="margin: 0.5rem 0; color: #b8dbc4;">Soluções Tecnológicas Espaciais</p>
  </div>
</div>
...
Tens dúvidas? Entra em contacto connosco:
